...
for i in np.arange(10):
        ...
        plt.legend()
plt.savefig('/home/user/tmp/gains.png',bbox_inches='tight')
plt.close()

# save calibs
sav_fl = '/home/user/tmp/'+pol+'cal.npz'
np.savez(sav_fl,ant_delays=np.zeros(10),b_delays=np.zeros(45),src_name=src,src_model=src_model,gains=gains,pol=pol,aname=aname,freq_cadence=freq_cadence)
